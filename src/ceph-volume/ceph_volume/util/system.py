...
def get_mounts(devices=False, paths=False, _proc_mounts=None):
    """
    ...
    .. note: _proc_mounts is just meant for easier testing
    """
    devices_mounted = {}
    paths_mounted = {}
    ...
    for line in proc_mounts:
        ...
        if not os.path.exists(device) and device not in do_not_skip:
            continue
